...
from vanilla_ml.supervised.ranking.rank_linear_svm import LinearSVMRank
from vanilla_ml.util import data_io
from vanilla_ml.util.metrics.ranking import ndcg


class TestLinearSVMRank(unittest.TestCase):
    ...
    def test_toy_data(self):
        ...
        rnk = LinearSVMRank(max_iterations=100, penalty_factor=0.01,
